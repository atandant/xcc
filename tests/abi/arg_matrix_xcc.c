...
int main(void)
{
    ...
    int bad = 0;
    s1.x[0] = 1; s2.x[0] = 2; s2.x[1] = 3;
    s3.x[0] = 3; s3.x[2] = 4; s4.x[0] = 4; s4.x[3] = 5;
    s5.x[0] = 5; s5.x[4] = 6; s7.x[0] = 7; s7.x[6] = 8;
    s8.x[0] = 8; s8.x[7] = 9; s9.x[0] = 9; s9.x[8] = 10;
    s12.x[0] = 12; s12.x[11] = 13; s15.x[0] = 15; s15.x[14] = 16;
    s16.x[0] = 16; s16.x[15] = 17; s17.x[0] = 17; s17.x[16] = 18;
    s24.x[0] = 24; s24.x[23] = 25; s32.x[0] = 32; s32.x[31] = 33;
    bad = bad + take1(s1) + take2(21, s2);
    bad = bad + take3(1, 2, 3, 4, 5, s3);
    bad = bad + take4(1, 2, 3, 4, 5, 6, s4);
    bad = bad + take5(s5, 22) + take7(1, 2, 3, 4, 5, s7);
    bad = bad + take8(1, 2, 3, 4, 5, 6, s8) + take9(s9);
    bad = bad + take12(1, 2, 3, 4, s12);
    bad = bad + take15(1, 2, 3, 4, 5, s15);
