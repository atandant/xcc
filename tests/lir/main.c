...
int main(void)
{
    LirTestCase cases[] = {
        ...
        {"dce-dead-chain",test_dce_dead_chain},
        ...
        {"mem2reg-i32-phi",test_mem2reg_i32_phi}, {"mem2reg-loop",test_mem2reg_loop},
        {"mem2reg-float",test_mem2reg_float}, {"mem2reg-f80",test_mem2reg_f80},
        {"mem2reg-rejections",test_mem2reg_rejections},
        {"copy-prop-f80-chain",test_copy_prop_f80_chain},
        {"copy-prop-f80-self-move",test_copy_prop_f80_self_move},
        ...
        {"i32-spill-slots",test_i32_spill_slots},
        {"emit-i32-spills",test_emit_i32_spills},
